  ...
  Widget build(BuildContext context) {
    ...
    if (_error != null) {
      return Scaffold(
        appBar: phoneAppBar(
          context,
          AppBar(title: const Text('Accounts & Invoices')),
        ),
        body: Center(
          child: Padding(
                            ...
                            children: [
                              ...
                              FilledButton.icon(
                                ...
                                onPressed: () {
                                  ...
                                  final allocatedTotal = allocations
                                      .fold<double>(
                                        0,
                                        (sum, item) =>
                      ...
                      desktop: Row(
                        children: [
                          _metric(
                            ...
                            color:
                                _asDouble(_summary?['outstanding_balance']) > 0
                                ? _darkRed
                                : null,
                          ),
                          const SizedBox(width: 10),
          ...
          if (!desktop) {
            return ListView(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                SizedBox(
                  height: isPhoneLayout(context) ? null : 500,
                  child: summaryPanel(),
                ),
              ],
            );
