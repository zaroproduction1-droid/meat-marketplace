...
/// Reusable CutLink SVG region selector.
///
...
class InteractiveCutsMap extends StatefulWidget {
  const InteractiveCutsMap({
    super.key,
    ...
    this.viewBoxWidth = 1672,
    this.viewBoxHeight = 941,
  ...
  @override
  State<InteractiveCutsMap> createState() => _InteractiveCutsMapState();
}

class _InteractiveCutsMapState extends State<InteractiveCutsMap> {
  double get _viewBoxWidth => widget.viewBoxWidth;
  double get _viewBoxHeight => widget.viewBoxHeight;
  ...
  @override
  void didUpdateWidget(covariant InteractiveCutsMap oldWidget) {
  ...
  Future<void> _loadSvgRegions() async {
    try {
      ...
      if (!widget.renderSvg && (artworkBytes == null || artworkBytes.isEmpty)) {
        throw StateError(
          'The embedded CutLink artwork could not be read from ${widget.assetPath}.',
        );
      }
                ...
                return MouseRegion(
                  ...
                  child: GestureDetector(
                    ...
                    child: Stack(
                      fit: StackFit.expand,
                      children: [
                        if (widget.renderSvg && _regions != null)
                          SvgPicture.asset(widget.assetPath, fit: BoxFit.fill),
                        if (!widget.renderSvg && _artworkBytes != null)
                          Image.memory(
                            _artworkBytes!,
                            fit: BoxFit.fill,
                        ...
                        if (_loadError == null &&
                            (_regions == null ||
                                (!widget.renderSvg && _artworkBytes == null)))
                          const Center(
                          ...
                          ColoredBox(
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: Text(
                                  'Unable to load interactive cut map.\n'
                                  '$_loadError',
