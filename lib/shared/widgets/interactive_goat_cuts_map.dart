...
class _InteractiveGoatCutsMapState extends State<InteractiveGoatCutsMap> {
  ...
  static final List<_GoatRegion> _regions = [
    ...
    _GoatRegion.rects(
      cut: 'Forequarter',
      rects: const [Rect.fromLTWH(619, 110, 238, 70)],
    ),
    _GoatRegion.rects(
      cut: 'Hindquarter',
      rects: const [Rect.fromLTWH(883, 110, 248, 70)],
    ),
    _GoatRegion.rects(
      cut: 'Whole Goat',
      rects: const [Rect.fromLTWH(247, 1037, 280, 70)],
    ),
    _GoatRegion.rects(
      cut: 'Trim / Manufacturing',
      rects: const [Rect.fromLTWH(555, 1037, 438, 70)],
    ),
    _GoatRegion.rects(
      cut: 'Offal / Other',
      rects: const [Rect.fromLTWH(1021, 1037, 280, 70)],
    ),
  ];
...
class _GoatRegion {
  ...
  factory _GoatRegion.rects({required String cut, required List<Rect> rects}) {
    return _GoatRegion._(cut: cut, paths: const [], rects: rects);
  }
